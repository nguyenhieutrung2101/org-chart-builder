...
vi: {
  ...
  docEmptyHint:'Bấm một box để sửa. Kéo box sang ngang để dịch trong hàng; kéo nền để di chuyển trang, lăn chuột để zoom.',
...
en: {
  ...
  docEmptyHint:'Click a box to edit it. Drag a box sideways within its row; drag the background to pan, scroll to zoom.',
