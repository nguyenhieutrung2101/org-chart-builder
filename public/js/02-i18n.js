...
vi: {
  ...
  lblBoxW:'Bề rộng box (mm, toàn trang)', ckAutoH:'Chiều cao trang tự động theo nội dung (giữ bề rộng khổ giấy)',
...
en: {
  ...
  lblBoxW:'Box width (mm, whole page)', ckAutoH:'Page height follows the content (paper width kept)',
