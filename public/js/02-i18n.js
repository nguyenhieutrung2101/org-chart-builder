...
vi: {
  ...
  btnRowUp:'▲ Lên một hàng', btnRowDown:'▼ Xuống một hàng',
  rowHint:'Kéo box lên/xuống (có đường kẻ hàng hướng dẫn) hoặc dùng hai nút trên để đổi hàng; box phía dưới bị đùn theo.',
  lblLogo:'Logo (dán mã SVG, hiện cố định 8 mm ở góc trái trên)', phLogo:'<svg xmlns="http://www.w3.org/2000/svg" …>…</svg>', logoHint:'Chỉ nhận mã SVG; script và sự kiện bị loại bỏ. Xoá trống để bỏ logo.', logoBad:'Mã SVG không hợp lệ', ckAutoH:'Chiều cao trang tự động theo nội dung (giữ bề rộng khổ giấy)',
  ckShowLv:'Hiện cấp (Tx) sau chức danh', ckStack:'Xếp dọc thành nhóm', stackHint:'Các box anh em cùng tick xếp thành một cột dọc, nối bằng một đường dọc bên trái vào cạnh trái từng box.',
  phPersonLines:'Mỗi người một dòng', annotNone:'— Không —', annotUndefined:'(chưa định nghĩa ở Ghi chú)',
  docEmptyHint:'Bấm một box để sửa. Kéo box lên/xuống để đổi hàng; kéo nền để di chuyển trang, lăn chuột để zoom.',
...
en: {
  ...
  btnRowUp:'▲ Up one row', btnRowDown:'▼ Down one row',
  rowHint:'Drag a box up/down (row guides appear) or use the two buttons; boxes below are pushed along.',
  lblLogo:'Logo (paste SVG code, fixed 8 mm high at the top-left)', phLogo:'<svg xmlns="http://www.w3.org/2000/svg" …>…</svg>', logoHint:'SVG only; scripts and event handlers are stripped. Clear to remove the logo.', logoBad:'Invalid SVG code', ckAutoH:'Page height follows the content (paper width kept)',
  ckShowLv:'Show level (Tx) after the title', ckStack:'Stack vertically as a group', stackHint:'Sibling boxes that are also ticked form one vertical column fed from a single line on the left into each box\'s left edge.',
  phPersonLines:'One person per line', annotNone:'— None —', annotUndefined:'(not defined in Notes)',
  docEmptyHint:'Click a box to edit it. Drag a box up or down to change its row; drag the background to pan, scroll to zoom.',
