...
const drows = await ev(() => { docRowDrag = { id: rootIds[0], shift: 0 }; renderDoc(); const first = document.querySelector('#docPage .drows').classList.contains('in') && document.querySelector('#docPage .dbox.drag') !== null; renderDoc(); const second = document.querySelector('#docPage .drows').classList.contains('in'); docRowDrag = null; renderDoc(); return { first, second, cleared: !document.querySelector('#docPage .drows') }; });
